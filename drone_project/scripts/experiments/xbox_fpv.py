...
try:
    ...
    raise SystemExit(
        "Missing pygame. The Xbox/gamepad controller needs pygame, but pygame "
        "does not currently provide Windows wheels for Python 3.14. Use a "
        "Python 3.13 virtual environment for this optional controller, then run:\n"
