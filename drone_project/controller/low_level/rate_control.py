...
G = 9.81
LEGACY_PROPELLER_MESH_CENTERS_M = (
    (0.029886, -0.031685, 0.012625),
    (-0.033400, 0.031601, 0.012625),
    (0.029886, 0.031601, 0.012625),
    (-0.033400, -0.031685, 0.012625),
)
LEGACY_PROP_ARM_LENGTH_M = sum(
    math.hypot(center[0], center[1]) for center in LEGACY_PROPELLER_MESH_CENTERS_M
) / len(LEGACY_PROPELLER_MESH_CENTERS_M)
LEGACY_MODULE_INERTIA_BOX_M = (0.176, 0.176, 0.166)
LEGACY_BODY_COLLISION_BOX_M = (0.090, 0.090, 0.026)
LEGACY_COLLISION_ROD_DIAMETER_M = 0.003
LEGACY_COLLISION_NODE_DIAMETER_M = 0.004

BOLT_3IN_MASS_KG = 0.150
BOLT_3IN_TOTAL_THRUST_GF = 250.0
BOLT_3IN_MAX_THRUST_N = BOLT_3IN_TOTAL_THRUST_GF * G / 1000.0 / 4.0
BOLT_3IN_MAX_MOTOR_SPEED = 2600.0
BOLT_3IN_YAW_DRAG_ARM_M = 0.010
BOLT_3IN_ARM_LENGTH_M = 0.070
BOLT_3IN_GEOMETRY_SCALE = BOLT_3IN_ARM_LENGTH_M / LEGACY_PROP_ARM_LENGTH_M
BOLT_3IN_MOTOR_XY_M = BOLT_3IN_ARM_LENGTH_M / math.sqrt(2.0)
BOLT_3IN_MOTOR_Z_M = LEGACY_PROPELLER_MESH_CENTERS_M[0][2] * BOLT_3IN_GEOMETRY_SCALE
BOLT_3IN_PROP_RADIUS_M = 0.0381
BOLT_3IN_MODULE_INERTIA_BOX_M = tuple(value * BOLT_3IN_GEOMETRY_SCALE for value in LEGACY_MODULE_INERTIA_BOX_M)
BOLT_3IN_BODY_COLLISION_BOX_M = tuple(value * BOLT_3IN_GEOMETRY_SCALE for value in LEGACY_BODY_COLLISION_BOX_M)
BOLT_3IN_COLLISION_ROD_DIAMETER_M = LEGACY_COLLISION_ROD_DIAMETER_M * BOLT_3IN_GEOMETRY_SCALE
BOLT_3IN_COLLISION_NODE_DIAMETER_M = LEGACY_COLLISION_NODE_DIAMETER_M * BOLT_3IN_GEOMETRY_SCALE

DEFAULT_MASS_KG = BOLT_3IN_MASS_KG
DEFAULT_MAX_THRUST_N = BOLT_3IN_MAX_THRUST_N
DEFAULT_MAX_MOTOR_SPEED = BOLT_3IN_MAX_MOTOR_SPEED
DEFAULT_YAW_DRAG_ARM_M = BOLT_3IN_YAW_DRAG_ARM_M
DEFAULT_GEOMETRY_SCALE = BOLT_3IN_GEOMETRY_SCALE
DEFAULT_MODULE_INERTIA_BOX_M = BOLT_3IN_MODULE_INERTIA_BOX_M
DEFAULT_BODY_COLLISION_BOX_M = BOLT_3IN_BODY_COLLISION_BOX_M
DEFAULT_PROP_RADIUS_M = BOLT_3IN_PROP_RADIUS_M
DEFAULT_COLLISION_ROD_DIAMETER_M = BOLT_3IN_COLLISION_ROD_DIAMETER_M
DEFAULT_COLLISION_NODE_DIAMETER_M = BOLT_3IN_COLLISION_NODE_DIAMETER_M

MOTORS = (
    {"pos": (BOLT_3IN_MOTOR_XY_M, -BOLT_3IN_MOTOR_XY_M, BOLT_3IN_MOTOR_Z_M), "spin": 1.0},
    {"pos": (-BOLT_3IN_MOTOR_XY_M, BOLT_3IN_MOTOR_XY_M, BOLT_3IN_MOTOR_Z_M), "spin": 1.0},
    {"pos": (BOLT_3IN_MOTOR_XY_M, BOLT_3IN_MOTOR_XY_M, BOLT_3IN_MOTOR_Z_M), "spin": -1.0},
    {"pos": (-BOLT_3IN_MOTOR_XY_M, -BOLT_3IN_MOTOR_XY_M, BOLT_3IN_MOTOR_Z_M), "spin": -1.0},
)
