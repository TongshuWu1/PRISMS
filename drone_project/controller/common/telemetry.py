...
VECTOR_LABELS = {
    ...
    "torque_world": ("x", "y", "z"),
    "torque_body": ("x", "y", "z"),
    "torque_body_raw": ("x", "y", "z"),
    "torque_limited_delta_body": ("x", "y", "z"),
    "virtual_torque_body": ("x", "y", "z"),
    "moment_cmd": ("x", "y", "z"),
    "att_error": ("x", "y", "z"),
    "accel_cmd": ("x", "y", "z"),
    "pid_accel_p": ("x", "y", "z"),
    ...
    "reference_b2": ("x", "y", "z"),
    "reference_b3": ("x", "y", "z"),
    "collective_axis": ("x", "y", "z"),
    "inertia_body_diag": ("xx", "yy", "zz"),
    "inertia_body_offdiag": ("xy", "xz", "yz"),
    "alpha_cmd_body": ("x", "y", "z"),
    "inertia_torque_body": ("x", "y", "z"),
    "angular_momentum_body": ("x", "y", "z"),
    "gyroscopic_torque_body": ("x", "y", "z"),
    "wrench_cmd": ("Fx", "Fy", "Fz", "Tx", "Ty", "Tz"),
    "wrench_achieved": ("Fx", "Fy", "Fz", "Tx", "Ty", "Tz"),
    "wrench_residual": ("Fx", "Fy", "Fz", "Tx", "Ty", "Tz"),
    "wrench_weighted_residual": ("Fx", "Fy", "Fz", "Tx", "Ty", "Tz"),
    "wrench_weights": ("Fx", "Fy", "Fz", "Tx", "Ty", "Tz"),
    "omega": ("0", "1", "2", "3"),
    "omega_cmd": ("0", "1", "2", "3"),
