...
- Duration: `149.37999999993664` s

## Key Metrics

- `final_error_m`: `0.00896`
- `max_error_m`: `0.12902`
- `rms_error_m`: `0.06379`
- `mean_drone_power_ratio`: `0.34258`
- `mean_cable_support_fraction`: `0.70819`
- `max_thrust_fraction`: `0.77362`
- `max_tension_N`: `1.82924`
- `mean_abs_spool_velocity_m_s`: `0.07122`
- `p95_spool_acceleration_m_s2`: `1.00000`
- `max_spool_acceleration_m_s2`: `1.00000`
- `reel_in_work_J`: `6.92515`
- `thrust_limit_active_fraction`: `0.00000`
- `allocation_residual_active_fraction`: `0.00589`
- `slack_sample_fraction`: `0.00000`
- `coverage_fraction`: `1.00000`
- `contact_valid_fraction`: `0.96047`
- `mean_contact_force_N`: `0.54985`
- `mean_contact_quality`: `0.99988`
- `mean_normal_gap_m`: `-0.00333`
- `mean_blur_risk`: `0.44928`
